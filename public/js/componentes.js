...
export function renderCard(opcoes) {
    ...
    if (opcoes.disponivel === false) {
        ...
        card.appendChild(criarElemento("span", { classes: ["card__badge"], texto: "Em breve" }));
    }
    else {
...
export function renderCardConteudo(resumo) {
...
// ---------- Breadcrumb ----------
export function renderBreadcrumb(itens) {
...
// ---------- Progresso ----------
export function renderProgresso(posicaoAtual, total, acertos, erros) {
    ...
    cabecalho.appendChild(criarElemento("span", { classes: ["progresso__percentual"], texto: formatarPercentual(proporcao) }));
    ...
    detalhes.appendChild(criarElemento("span", { classes: ["progresso__acertos"], texto: `Acertos: ${acertos}` }));
    detalhes.appendChild(criarElemento("span", { classes: ["progresso__erros"], texto: `Erros: ${erros}` }));
    container.appendChild(detalhes);
    return container;
}
// ---------- Feedback ----------
export function renderFeedback(correto, explicacao, dica) {
 ...
 */
export function renderCaixaExplicacao(explicacao) {
    const container = criarElemento("div", {
...
// ---------- Resumo ----------
export function renderResumo(itens) {
...
export function renderQuestao(atividade) {
    const container = criarElemento("div", { classes: ["questao"] });
    container.appendChild(criarElemento("span", {
    ...
    switch (atividade.tipo) {
        case "multipla_escolha": {
            ...
            let selecionado = -1;
            const lista = renderOpcoes(opcoesEmbaralhadas.map((o) => o.texto), (indiceExibido) => {
        ...
        case "relacionamento": {
            ...
            const respostas = atividade.colunaA.map(() => -1);
...
export function renderOpcoes(opcoes, aoSelecionar) {
...
function renderOpcoesNumeradas(opcoes, aoSelecionar) {
