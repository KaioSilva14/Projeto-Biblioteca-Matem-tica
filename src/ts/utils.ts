// utils.ts — funções utilitárias compartilhadas entre módulos.
export {};
...
export function criarElemento<K extends keyof HTMLElementTagNameMap>(
  tag: K,
  opcoes: { classes?: string[]; texto?: string; atributos?: Record<string, string> } = {}
...
export function limparElemento(elemento: Element): void {
...
export function textoOuPadrao(valor: unknown, padrao: string): string {
